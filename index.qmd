...
🗓 **2025/05/25**  
Rパッケージ「[fixes]{.fira-code}」バージョン0.4.0をCRANで公開しました！（→ [CRAN](https://cran.r-project.org/web/packages/fixes/index.html), [Tips](pages/tips/250525_fixes/index.qmd)へ）  
📌 Staggered DiDのイベントスタディにも対応しました！
