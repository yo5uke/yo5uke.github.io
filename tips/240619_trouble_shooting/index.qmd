...
- **発生環境**：開発コンテナ内^[[この記事](../240504_container/index.html)で紹介した開発コンテナを使用。]
- **エラーが発生したコマンド**：
...
- **発生環境**：開発コンテナ内^[[この記事](../240504_container/index.html)で紹介した `TinyTeX` ボリュームを使用。]
...
- **発生したエラー**：「VS Code Server for WSL closed unexpectedly」という表示と、以下のエラーが出力される。

```{.sh filename="Terminal"}
/home/yo5uke/.vscode-server/bin/f1e16e1e6214d7c44d078b1f0607b2388f29d729/bin/code-server: 12: /home/yo5uke/.vscode-server/bin/f1e16e1e6214d7c44d078b1f0607b2388f29d729/node: not found
```
