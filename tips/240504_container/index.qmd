...
Mac ユーザーは Homebrew を使ってインストールします。
...
![2回目なので git is already installed と表示されてます…。](homebrew.png)
...
::: {.callout-important}
個々からの作業で重要なことですが、これから説明する `renv` 等で記録したら、コミット、プッシュ、プルを通じてファイルを共有することを忘れないでください。
:::
