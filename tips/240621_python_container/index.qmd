...
WSL2, Ubuntu, Homebrew, VSCode, Docker, Git, GitHub を使用されたことがあり、[以前の記事](https://yo5uke.github.io/tips/240504_container/)を読んでいただいた方は @sec-build-env まで飛んでいただいて大丈夫だと思います。
