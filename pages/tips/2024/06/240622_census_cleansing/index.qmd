...
canonical-url: https://yo5uke.com/pages/tips/2024/06/240622_census_cleansing/
aliases:
- /pages/tips/240622_census_cleansing/index.html
---
## はじめに
...
- ワーキングディレクトリを指定してあること^[Rプロジェクトを使用している場合は問題ありません。Rプロジェクトについては[こちら](/pages/tips/2024/05/240515_rproj/index.html)をご参照ください。]。
...
```{r}
test <- read_csv(
  here("data/census_2020/tblT001141H3622.txt"),
...
census_files <- list.files(
  here("data/census_2020"), # ファイルが入っているフォルダのパス
  pattern = "\\.txt$",
  full.names = TRUE
)
...
read_csv(
  here("data/census_2020/tblT001141H3725.txt"),
  skip = 1,
  locale = locale(encoding = "Shift_JIS")
) |>
  filter(...2 == 0 | ...2 == 1) |>
