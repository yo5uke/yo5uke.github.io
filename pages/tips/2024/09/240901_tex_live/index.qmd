...
editor: visual
canonical-url: https://yo5uke.com/pages/tips/2024/09/240901_tex_live/
aliases:
- /pages/tips/240901_tex_live/index.html
---
::: callout-note
## Typstという選択肢

（2025/10/27追記）LaTeX環境をローカルで整えるというのは非常に魅力的な選択肢である一方、複雑な設定やトラブルシューティングが必要になることも多々あります。\
そこで、近年注目を集めているのが[Typst](https://typst.app/)という新しい文書作成システムです。Typstは、LaTeXのような高品質な文書作成を目指しつつも、より直感的で使いやすい設計が特徴です。\
LaTeXユーザーの方にとって移行は少しハードルが高いかもしれませんが、もし全くの初心者であれば、Typstを試してみるのも良い選択肢かもしれません。

以下の記事を書きましたので、興味がある方はぜひご覧ください！\
[Typst 入門](/pages/tips/2025/10/251026_typst/index.qmd)
:::
