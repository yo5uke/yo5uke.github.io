...
皆さんはR Projectを使用しているでしょうか。再現可能な研究のための1つのツールにR Projectがあります。ここではそれそのものについて詳しくは書きませんが^[R Projectについては[こちら](../../../2024/05/240515_rproj/index.qmd)をご覧ください。]、PositronにはR Projectと同様のシステムがありません。
...
:::{.callout-tip appearance="minimal"}
[【Positron】拡張機能「Air」を使う【フォーマッタ】](../../10/251016_air/index.qmd)
:::
