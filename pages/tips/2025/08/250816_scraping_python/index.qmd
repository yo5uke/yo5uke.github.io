...
[Rのコードを紹介したページ](../../06/250613_scraping_pop_by_mesh/index.qmd)と同じで、国勢調査をもとに公開しているメッシュごとの人口データをダウンロードします。URLは以下です。
...
`a`タグの探し方などについては、[こちら](../../03/250319_scraping/index.qmd#ファイルのリンクを取得)で簡単に説明しています。
:::
