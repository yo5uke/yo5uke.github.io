...
**追加：**簡略化前のサマライズしたデータ（1市町村を1行に集約したデータ）も提供します。簡略化ファイルよりデータサイズは大きいですが、Geopackage形式かつ正確ということで、精密さが求められる時にはよく使っています。
...
[サマライズ済みGPKGファイル](/data/jpn_geojson/jp_muni_summarise.zip){download="jp_muni_summarise.zip"}
