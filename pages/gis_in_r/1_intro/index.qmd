...
R言語では主に{sf}パッケージを使ってGISを扱います。また、{tidyverse}パッケージを使うことで、データの前処理や可視化を行うことができます。

また、**R Projectを作成し使用することを前提**とします^[R Projectと後述の`here`については[こちら](/pages/tips/2024/05/240515_rproj/index.qmd)を参照して下さい。]。
...
また、公園のデータはCRSが設定されていないようです。その設定も行います。CRSについては[こちら](/pages/gis_in_r/5_crs/index.qmd)を参照してください。
